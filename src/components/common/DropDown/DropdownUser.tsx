...
export const DropdownUser = () => {
  ...
  // Conditionally call useSharedTips only if id exists
  const { data } = id ? useSharedTips(`${id}`) : { data: null };
      ...
      >
        <span className="block text-right">
          <span className="block text-sm font-medium text-black dark:text-white">
            {id ? data?.data?.username : userDetails?.fullName}
          </span>
        ...
        {!id && (
          ...
          >
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M0.410765 0.910734C0.736202 0.585297 1.26384 0.585297 1.58928 0.910734L6.00002 5.32148L10.4108 0.910734C10.7362 0.585297 11.2638 0.585297 11.5893 2.08924L6.58928 7.08924C6.26384 7.41468 5.7362 7.41468 5.41077 7.08924L0.410765 2.08924C0.0853277 1.76381 0.0853277 1.23617 0.410765 0.910734Z"
              fill=""
            />
          </svg>
        )}
