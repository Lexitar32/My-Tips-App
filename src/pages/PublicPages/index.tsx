            ...
            <div className="px-6 pb-32 mx-auto max-w-7xl pt-36 sm:pt-60 lg:px-8 lg:pt-32">
              <div className="max-w-2xl mx-auto gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                  <h1 className="text-5xl font-semibold leading-tight tracking-tight text-gray-900 text-pretty">
                    Daily Home Tips: Energy, Electricity & Maintenance
                  </h1>
                  <p className="mt-4 text-lg text-gray-500 text-pretty sm:max-w-md lg:max-w-none">
                    Get daily tips to save energy, optimize electricity, and
                    maintain your home. Simple, actionable advice for a smarter,
